...
XH1=XH1';
filename2=sprintf('E_high_fidelity_%d.txt',mm);
%filename2=sprintf('P_high_fidelity.txt');
yH=load(filename2); %load output data
yH=yH';
yH1=load('E_high_fidelity.txt');
yH1=yH1';
%y=[yL yH];
m=length(XH1(1,:));
%idx = randperm(m);
...
filename3=sprintf('C:/15 Batch Thesis/Binary/Binary_E/workspace_E_%d_%d.mat',mm,ridzy);
save(filename3)
end
end
