function [J grad grad_alpha2]=Neural_NL(X,y,hidden_layer1_node,hidden_layer2_node,lambda,Theta,alpha2)
...
h=a4;
c1=J;
J=sum(sum((y*alpha2-h).^2))/(m);
grad_alpha2=sum(sum((h-y*alpha2).*y))/m;
